  ...
  return (
    <SafeAreaView style={{ height: SIZES.height }}>
      <Image
        ...
        blurRadius={30}
      />
      <ReusableHeader title={"Add Ratings"} backbtn={true} /> {/* Check if ReusableHeader is correctly imported */}
        ...
        <View style={styles.ratingBox}>
          <View style={styles.image}>
            <AssetImage
              ...
              height={70}
              radius={99}
            /> {/* Ensure AssetImage is correctly imported */}
          </View>
          ...
          <View style={{ paddingTop: 40 }}>
            <Rating
              ...
              maxStars={5}
              bordered={false}
            /> {/* Ensure RatingInput is correctly imported */}
            <Text
              style={[
                styles.small,
